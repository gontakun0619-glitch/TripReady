...
if (category === 'basic' || category === 'life') {
...
if (category === 'basic') {
updateDetailCard('sim', currentCountryData.sim);
updateDetailCard('currency', currentCountryData.currency);
updateDetailCard('payment', currentCountryData.payment);
} else if (category === 'life') {
updateDetailCard('transport', currentCountryData.transport);
updateDetailCard('delivery', currentCountryData.delivery);
updateDetailCard('translation', currentCountryData.translation);
}
}
...
if (!basicEl || !detailedEl || !card) return;
