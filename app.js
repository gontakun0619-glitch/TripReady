...
// 国データ
showDebug('  - thailand-data.js loaded? ' + (typeof thailandData !== 'undefined'));
showDebug('  - korea-data.js loaded? ' + (typeof koreaData !== 'undefined'));
...
showDebug('  - openingScreen: ' + (openingScreen ? '✅ OK' : '❌ null'));
const countrySelection = document.getElementById("country-selection");
showDebug('  - countrySelection: ' + (countrySelection ? '✅ OK' : '❌ null'));
