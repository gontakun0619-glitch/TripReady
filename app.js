// ============================================
// デバッグ版 - 2025年2月8日19:35
// ============================================

// 読み込み確認
alert('🔍 app.js 読み込み開始');

// thailand-data.jsが読み込まれているか確認
setTimeout(() => {
    if (typeof thailandData === 'undefined') {
        alert('❌ thailand-data.js が読み込まれていない！');
    } else {
        alert('✅ thailand-data.js 読み込み成功！');
    }
}, 100);
...
alert("🔍 DOMContentLoaded完了 - オープニング開始");
};
...
alert("🔍 国カード検索: " + countryCards.length + "個見つかりました");
