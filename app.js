...
console.log('========================================');
console.log('【STEP 0】app.js読み込み開始');
console.log('========================================');
...
// 国データ
console.log('【STEP 1】countryData定義開始');
console.log('  - thailandData exists?', typeof thailandData !== 'undefined');
console.log('  - koreaData exists?', typeof koreaData !== 'undefined');
if (typeof thailandData !== 'undefined') {
    console.log('  - thailandData.name:', thailandData.name);
}
if (typeof koreaData !== 'undefined') {
    console.log('  - koreaData.name:', koreaData.name);
}
...
// オープニングアニメーション
console.log('【STEP 3】オープニングアニメーション設定');
console.log('  - 1.5秒後に実行されます...');
setTimeout(() => {
    console.log('【STEP 4】オープニングアニメーション実行！');
    console.log('  - openingScreen.classList.add("slide-up") を実行');
    openingScreen.classList.add("slide-up");
    console.log('  - ✅ slide-upクラスを追加しました');
    console.log('  - openingScreen.classList:', openingScreen.classList);
    setTimeout(() => {
        openingScreen.style.display = "none";
        console.log('【STEP 5】国選択画面を表示');
        countrySelection.classList.remove("hidden");
        console.log('  - ✅ hiddenクラスを削除');
        countrySelection.classList.add("show");
        console.log('  - ✅ showクラスを追加');
        console.log('========================================');
        console.log('【完了】オープニングアニメーション完了！');
        console.log('========================================');
    }, 600);
}, 1500);
